...
const HotelBookingPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // Collect traveler details from the form (for now, use mock data)
    const name = 'Hotel Guest';
    ...
    try {
      await createBooking(
        ...
        [{
          type: 'hotel',
          id: hotelPackage.id,
          title: hotelPackage.name,
          image: selectedRoomType.image,
          price: hotelPackage.breakdown.total,
          quantity: 1,
          details: hotelPackage
        }],
        'card',
        undefined,
        hotelPackage.breakdown.total
      );
